  ...
  return (
    <div className="mx-2 ">
      <div className="flex justify-center items-center mt-50">
        <form className="max-w-[400px] w-full flex flex-col gap-3 ">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input type="email" id="email" className="border border-[#c9c9c9] px-3 py-2 focus:outline-none focus:border-[#c9c9c9] focus:ring-2 focus:ring-[#c9c9c9] transition rounded-full " placeholder="Your Email" />
          </div>


          <div className="flex flex-col gap-1.5 relative">
            <label  className="text-gray-600 font-light" htmlFor="password">Password</label>
            <input type={showPass ? "password" : "text"} id="password" className="border border-[#c9c9c9] px-3 py-2 focus:outline-none focus:border-[#c9c9c9] focus:ring-2 focus:ring-[#c9c9c9] transition rounded-full " placeholder="Your Password" />
          ...
          <div className='flex flex-col gap-1'>
            ...
            <button className="btn bg-[#1a1a1a] text-white font-semibold rounded-full  py-3 border-[#e5e5e5]">
